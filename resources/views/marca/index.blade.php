                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td style="display: block;  margin: auto;">
                            @can('delete', $marca)
                            <button type="button" class="btn btn-danger" data-toggle="modal" data-target="#modal-danger" data-data="{{$marca->id}}">
                                <i class="fas fa-trash-alt" aria-hidden="true"></i>
                            </button>
                            @endcan
                            @can('update', $marca)
                            <a href="{{ route('marca.edit', $marca->id) }}" class= "btn btn-info"><i class="fas fa-pencil-alt"></i></a>
                            @endcan
                        </td>
                    </tr>
                    @endforeach
...
<div class="modal fade" id="modal-danger">
    <div class="modal-dialog">
      <div class="modal-content">
        ...
        <form action="{{ route('marca.destroy', 'test')}}" method="post">
            @csrf
            @method('DELETE')
